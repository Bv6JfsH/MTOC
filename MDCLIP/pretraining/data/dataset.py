...
class Dataset(_TorchDataset):
    ...
    def _transform(self, index: int):
        ...
        # res = self.transform(data_i) if self.transform is not None else data_i
        # numpy_image = res['image'].detach().numpy()
        # res_image = np.transpose(numpy_image, (1, 2, 0))
        # res['image'] = transforms_extra(image=res_image)['image']
        # return res
