...
@register_model
def unireplknet_p(in_1k_pretrained=True, weights=None, **kwargs ):
    model = UniRepLKNet(depths=UniRepLKNet_A_F_P_depths, num_classes=None, init_cfg={'checkpoint': "./MDCLIP/unireplknet_p_in1k_224_acc80.23.pth"} if weights is None else weights, dims=(64, 128, 256, 512), attempt_use_lk_impl=False, **kwargs)
    # checkpoint = torch.load('unireplknet_p_in1k_224_acc80.23.pth', map_location='cpu')
    # model.load_state_dict(checkpoint)
